...
export default function AboutMe() {
  const viniAge = calculateAge(new Date(2004, 3, 3));
        ...
        <div className={style.aboutMeText}>
          ...
          <div className={style.aboutMeContent}>
            ...
            <h1 className={style.typing}>
              I'm <span>Vini R Jacob</span>
            </h1>
            <p>
              A {viniAge}-year-old software developer with a passion for coding
              and a keen interest in building innovative solutions. I'm
              currently based in Manaus, Brasil, where I was born. I'm pursuing
              a degree in 'Computer Science' at Uninorte College. Strong
              foundation in web development, problem-solving, and teamwork.
            </p>
            <a
              href={`${process.env.PUBLIC_URL}/Vinícius R Jacob.pdf`}
